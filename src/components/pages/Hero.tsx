...
function Hero() {
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-slate-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="max-w-6xl w-full flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        <div className="flex-1 text-center">
          <h2 className="text-xl md:text-2xl font-semibold text-gray-600 mb-2">Shopping And</h2>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">Department Store.</h1>
